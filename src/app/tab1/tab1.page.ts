...
export class Tab1Page {
  form: any = {};
  constructor(private geoLocationService: GeoLocationService, private toastController: ToastController, private storageManagementService: StorageManagementService) {}
  ...
  async sendToWhatsapp() {
    ...
    window.open(`https://api.whatsapp.com/send?phone=6282127207662&text=${output}`, '_blank');
  ...
  async sendToTelegram() {
    ...
    window.open(`https://t.me/arsaa12e?start=${output}`, '_blank');
  }
  ...
  async sendToEmail() {
    ...
    const url = `mailto:vitojk5112@gmail.com?subject=Data&20Informasi&body=${output}`;
